...
class Multiplication(BinaryOperator):
    def __str__(self):
        return "(" + str(self.levy_argument) + "*" + str(self.pravy_argument) + ")"
    def diff(self):
        return self.levy_argument.diff() * self.pravy_argument + self.pravy_argument.diff() * self.levy_argument
...
class ln(UnaryOperator):
    ...
    def diff(self):
        return Multiplication(frc(cst(1), self.argument), self.argument.diff())
