...
class Multiplication(BinaryOperator):
    def __str__(self):
        return "(" + str(self.levy_argument) + "*" + str(self.pravy_argument) + ")" #?self.levy_argument * self.pravy_argument #* TODO vypíšeme něco jako (levy_argument)*(pravy_argument)
        pass
    def diff(self):
...
class frc(UnaryOperator):
    ...
    def diff(self):
        return Multiplication(frc(identity(), mocnina(self.argument, 2)), -1)    #? self * self.diff(self)    #* TODO
        pass
